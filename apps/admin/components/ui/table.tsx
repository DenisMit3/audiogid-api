...
>(({ className, ...props }, ref) => (
    <tr
        ...
        className={cn(
            ...
            "hover:bg-primary/[0.02] data-[state=selected]:bg-primary/5",
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <th
        ref={ref}
        className={cn(
            "h-12 px-4 text-left align-middle font-semibold text-muted-foreground/80 text-xs uppercase tracking-wider [&:has([role=checkbox])]:pr-0",
            className
        )}
        {...props}
    />
