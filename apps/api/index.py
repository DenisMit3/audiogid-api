...
admin_cities_router = safe_import_router("api.admin.cities")  # Cities admin router
...
# Auto-migration removed to prevent stuck transactions. Use /v1/force-migrate instead.
...
if admin_cities_router: app.include_router(admin_cities_router, prefix="/v1")  # Cities routes
