...
@riverpod
HelperRepository helperRepository(HelperRepositoryRef ref) {
...
@riverpod
Future<List<Helper>> nearbyHelpers(NearbyHelpersRef ref) async {
  final repo = ref.watch(helperRepositoryProvider);
  return repo.getAllHelpers();
}

@riverpod
String mapStyleUrl(MapStyleUrlRef ref) {
