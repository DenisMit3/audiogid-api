...
class AudioPlayerScreen extends ConsumerWidget {
          ...
          return Column(
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(mediaItem.artist ?? '', style: Theme.of(context).textTheme.titleMedium, textAlign: TextAlign.center),
                  ],
                ),
              ),
              ...
              StreamBuilder<Duration>(
                stream: Stream.periodic(const Duration(milliseconds: 200), (_) => _currentPosition(audioHandler)),
                builder: (context, snapshot) {
  ...
  Duration _currentPosition(AudioHandler handler) {
     ...
     return state.position + Duration(milliseconds: (loops * state.speed).toInt());
  }
