...
class _ItineraryScreenState extends ConsumerState<ItineraryScreen> {
          ...
          if (itineraryIdsAsync.value?.isNotEmpty == true)
            IconButton(
              ...
              onPressed: () async {
                ...
                final pois =
                    await ref.read(poiRepositoryProvider).getPoisByIds(ids);
            ...
            onPressed: () {
              showDialog(
                ...
                builder: (context) => AlertDialog(
                  ...
                  content: const Text(
                      'Все добавленные места будут удалены из списка.'),
                  actions: [
                    TextButton(
  ...
  void _startTour(List<Poi> pois) {
    ...
    final tour = Tour(
      ...
      titleRu: 'Мой маршрут',
      items: pois
          .map((p) => TourItemEntity(
              id: p.id,
              tourId: 'custom_itinerary',
              poiId: p.id,
              orderIndex: 0,
              poi: p))
          .toList(),
