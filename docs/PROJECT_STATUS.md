...
### 2026-02-25
- Исправлена авторизация в админ-панели (HttpOnly cookies вместо localStorage)
- Исправлены bulk-операции POI (публикация, снятие, удаление)
- Исправлена сериализация GeoAlchemy2 в PoiVersion
- Исправлена загрузка медиа (source_page_url опционален)
- Удалены дублирующие API роуты с x-admin-token
- Улучшены сообщения валидации публикации (русский язык)
