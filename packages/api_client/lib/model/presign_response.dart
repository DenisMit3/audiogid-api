...
class PresignResponse {
  ...
  @override
  String toString() => 'PresignResponse[uploadUrl=$uploadUrl, finalUrl=$finalUrl, access=$access]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'upload_url'] = this.uploadUrl;
      json[r'final_url'] = this.finalUrl;
    if (this.access != null) {
  ...
  static PresignResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PresignResponse(
        ...
        finalUrl: mapValueOfType<String>(json, r'final_url')!,
